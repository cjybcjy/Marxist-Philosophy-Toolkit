...
| "Search for books / use Z-Library / check editions" | Source acquisition and integrity | `source-acquisition-integrity.md`, `source-policy.md`, then affected source index or framework |
